...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
        ...
        // Creating an object of User Class and getting the current logged in user(tester)
        User loggedInUser = userLoggedInService.getLoggedInUser();
        // Returning the list of Test Requests assigned to the current tester using the above User object
